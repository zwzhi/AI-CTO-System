...
当前工作版本为 `v2-codex-native`，发布标签为 `v2.0.0-codex-native`；v1 治理基线由 Git tag `v1.0.0-governance-baseline` 保留。v2 只优化入口、上下文和 Codex Host 对接，不删除历史文档，不改变 Runtime / Provider / Permission / Gate 行为。
