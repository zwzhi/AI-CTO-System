...
| CA-04 | Missing, expired, or wrong permission | `BLOCKED/PERMISSION_DENIED`; port is not called. |
...
| CA-08 | Confidence bound | Versionless input yields `L2`; a port claiming higher confidence is rejected. |
