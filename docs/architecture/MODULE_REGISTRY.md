...
| AI CTO Runtime Architecture | Layer 5 | 定义未来受控执行面、Workflow、权限、审批、预算、审计与 Adapter 合同，并包含 Phase 9C-2 Runtime Foundation MVP 与 `SYS-L5-HANDOFF-001` 内部 Intent-to-Runtime 控制平面连接 | Completed（Handoff 为 `INTERNAL_ONLY`） | [Runtime](../runtime/AI_CTO_RUNTIME_ARCHITECTURE.md)、[Foundation Plan](../runtime/RUNTIME_FOUNDATION_IMPLEMENTATION_PLAN.md)、[API Contract](../runtime/RUNTIME_API_CONTRACT.md)、[Controlled Intent Handoff Design](../superpowers/specs/2026-08-06-controlled-intent-runtime-handoff-design.md)、[Handoff Plan](../superpowers/plans/2026-08-06-controlled-intent-runtime-handoff-implementation.md)、[Handoff Source](../../runtime/integration/controlled-runtime-handoff-service.ts)、[Handoff Tests](../../runtime/tests/controlled-runtime-handoff.test.ts)、[Implementation Gate](../runtime/RUNTIME_IMPLEMENTATION_GATE.md)、[Runtime Source](../../runtime/services/runtime-foundation-service.ts)、[ADR-0018](../adr/ADR-0018-AI-CTO-RUNTIME-ARCHITECTURE.md)、[ADR-0021](../adr/ADR-0021-RUNTIME-FOUNDATION-TECH-STACK.md) |
...
| Capability Governance | Layer 5 | 管理内部 / 外部能力的准入、注册、评估、选择、权限和生命周期 | Completed | [Governance](../capability/CAPABILITY_GOVERNANCE_STANDARD.md)、[Admission](../capability/CAPABILITY_ADMISSION_PROCESS.md)、[Registry](../capability/CAPABILITY_REGISTRY_STANDARD.md)、[Evaluation](../capability/CAPABILITY_EVALUATION_STANDARD.md)、[Engineering Strategy](../capability/ENGINEERING_CAPABILITY_STRATEGY.md)、[Engineering Roadmap](../capability/ENGINEERING_CAPABILITY_ROADMAP.md)、[Documentation Requirement](../capability/DOCUMENTATION_CAPABILITY_REQUIREMENT.md)、[Documentation MVP Design](../runtime/DOCUMENTATION_CAPABILITY_MVP_IMPLEMENTATION_DESIGN.md)、[Test Plan](../runtime/DOCUMENTATION_CAPABILITY_MVP_TEST_PLAN.md)、[MVP Runtime](../../runtime/services/documentation-capability-runtime-service.ts) |
...
Capability Governance 的文档治理在 Phase 8.2 完成；Engineering Capability Strategy 与 Roadmap 已定义 Provider 无关的类别、合同、优先级、依赖、人类控制和 `Adopt / Improve / Merge / Deprecate / Remove` 策略动作。P0 的 Evidence-driven Documentation Assistant 已完成本地确定性 MVP：它只接受请求内的 Authorized Source Scope，以 Evidence-first 方式生成只读 Draft Package 并仅追加 Audit；不读取或写入文件、不接入 Provider/LLM/网络/MCP/CLI、不推进 Workflow 或 Knowledge 状态。它不是 Candidate、Registry Record 或 Activation，Capability Registry Record 仍为 `ABSENT`。真实 Capability Record、自动选择、插件接入和工具调用仍未实现。`Completed` 不表示已安装或激活任何外部能力。
