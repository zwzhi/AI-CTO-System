...
| Codex Integration | Layer 5 | 定义 Codex 作为可替换 Engineering Capability 的合同、Adapter、权限、人工控制、审计、失败与测试边界 | Completed | [Architecture](../runtime/CODEX_CAPABILITY_ARCHITECTURE.md)、[Contract](../runtime/CODEX_CAPABILITY_CONTRACT.md)、[Adapter](../runtime/CODEX_ADAPTER_DESIGN.md)、[Permission](../runtime/CODEX_PERMISSION_MODEL.md)、[Human Control](../runtime/CODEX_HUMAN_CONTROL_FLOW.md)、[Audit](../runtime/CODEX_AUDIT_STANDARD.md)、[Failure](../runtime/CODEX_FAILURE_HANDLING.md)、[Test Plan](../runtime/CODEX_CAPABILITY_TEST_PLAN.md)、[ADR-0024](../adr/ADR-0024-CODEX-CAPABILITY-INTEGRATION.md) |
