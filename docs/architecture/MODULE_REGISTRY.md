...
| Module Name | Layer | Purpose | Current Status | Related Documents |
|---|---|---|---|---|
| Intent Gateway | Layer 5 | 将用户输入转换为建议性 Intent Classification Result，并通过仓库权威的全局 Codex Skill 提供新对话入口、显式退出、自动介入、项目接续和渐进上下文路由 | Completed（Skill 已安装，自动介入待 Fresh Session 验证） | [Gateway](../intent/INTENT_GATEWAY_STANDARD.md)、[Automatic Intervention Standard](../intent/AI_CTO_AUTO_INTERVENTION_STANDARD.md)、[Fresh Session Pilot](../intent/AI_CTO_AUTO_INTERVENTION_FRESH_SESSION_PILOT.md)、[Classification](../intent/INTENT_CLASSIFICATION_STANDARD.md)、[Evidence](../intent/INTENT_EVIDENCE_STANDARD.md)、[Global Skill Source](../../skills/ai-cto-system/SKILL.md)、[ADR-0015](../adr/ADR-0015-INTENT-GATEWAY-GOVERNANCE.md) |
...
| AI CTO Runtime Architecture | Layer 5 | 定义受控执行面、Workflow、权限、审批、预算、审计与 Adapter 合同；包含 Runtime Foundation、`SYS-L5-HANDOFF-001` 内部 Handoff、`SYS-L5-DOC-ACT-001` 审批后受限 Documentation 执行桥，以及 L2–L4 的 Task Execution Envelope、Review Packet 绑定和显式 Checkpoint 追加前置合同 | Completed（受控链路为 `INTERNAL_ONLY`；Envelope / Review / Checkpoint 为 `EXTEND_EXISTING_MODULE`） | [Runtime](../runtime/AI_CTO_RUNTIME_ARCHITECTURE.md)、[Task Execution Envelope](../runtime/TASK_EXECUTION_ENVELOPE_STANDARD.md)、[Task Checkpoint](../protocol/TASK_CHECKPOINT_STANDARD.md)、[Controlled Intent Handoff Design](../superpowers/specs/2026-08-06-controlled-intent-runtime-handoff-design.md)、[Documentation Activation Design](../superpowers/specs/2026-08-06-controlled-documentation-capability-activation-design.md)、[Documentation Activation Plan](../superpowers/plans/2026-08-06-controlled-documentation-capability-activation-implementation.md)、[Approved Execution Source](../../runtime/integration/approved-documentation-execution-service.ts)、[Approved Execution Tests](../../runtime/tests/approved-documentation-execution.test.ts)、[Task Envelope Contract](../../runtime/task/task-execution-envelope-contract.ts)、[Task Envelope Tests](../../runtime/tests/task-execution-envelope.test.ts)、[ADR-0018](../adr/ADR-0018-AI-CTO-RUNTIME-ARCHITECTURE.md)、[ADR-0021](../adr/ADR-0021-RUNTIME-FOUNDATION-TECH-STACK.md) |
...
日常 Codex 操作入口统一遵循 [AI CTO–Codex Operating Model](./AI_CTO_CODEX_OPERATING_MODEL.md)：该文档是 Intent Gateway / Execution Routing 的操作映射，不是新 Module，也不产生 Runtime 或 Capability 激活。
...
Global AI CTO Skill Gateway 是 Intent Gateway 的薄入口扩展，不是独立 Module。其仓库内 Skill 包是唯一权威来源，用户级目录只允许通过受控 NTFS Junction 发现；Skill 负责识别适用请求、优先执行显式退出并渐进加载入口文档，不复制治理语料，也不把设计态 Runtime 或 Capability 变成可调用能力。最终隐式发现行为必须在安装后的新 Codex 对话中验证。
