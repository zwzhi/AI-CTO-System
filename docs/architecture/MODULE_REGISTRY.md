...
| Module Name | Layer | Purpose | Current Status | Related Documents |
|---|---|---|---|---|
| Intent Gateway | Layer 5 | 将用户输入转换为建议性 Intent Classification Result，并通过仓库权威的全局 Codex Skill 提供新对话入口、显式退出和渐进上下文路由 | Completed（Global Skill 已实现，待合并后安装与新对话验证） | [Gateway](../intent/INTENT_GATEWAY_STANDARD.md)、[Classification](../intent/INTENT_CLASSIFICATION_STANDARD.md)、[Evidence](../intent/INTENT_EVIDENCE_STANDARD.md)、[Global Skill Design](../superpowers/specs/2026-08-06-global-ai-cto-skill-gateway-design.md)、[Global Skill Plan](../superpowers/plans/2026-08-06-global-ai-cto-skill-gateway-implementation.md)、[Global Skill Source](../../skills/ai-cto-system/SKILL.md)、[ADR-0015](../adr/ADR-0015-INTENT-GATEWAY-GOVERNANCE.md) |
...
| AI CTO Runtime Architecture | Layer 5 | 定义受控执行面、Workflow、权限、审批、预算、审计与 Adapter 合同；包含 Runtime Foundation、`SYS-L5-HANDOFF-001` 内部 Handoff，以及 `SYS-L5-DOC-ACT-001` 审批后受限 Documentation 执行桥 | Completed（受控链路为 `INTERNAL_ONLY`） | [Runtime](../runtime/AI_CTO_RUNTIME_ARCHITECTURE.md)、[Controlled Intent Handoff Design](../superpowers/specs/2026-08-06-controlled-intent-runtime-handoff-design.md)、[Documentation Activation Design](../superpowers/specs/2026-08-06-controlled-documentation-capability-activation-design.md)、[Documentation Activation Plan](../superpowers/plans/2026-08-06-controlled-documentation-capability-activation-implementation.md)、[Approved Execution Source](../../runtime/integration/approved-documentation-execution-service.ts)、[Approved Execution Tests](../../runtime/tests/approved-documentation-execution.test.ts)、[ADR-0018](../adr/ADR-0018-AI-CTO-RUNTIME-ARCHITECTURE.md)、[ADR-0021](../adr/ADR-0021-RUNTIME-FOUNDATION-TECH-STACK.md) |
