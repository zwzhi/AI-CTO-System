...
| Module Name | Layer | Purpose | Current Status | Related Documents |
|---|---|---|---|---|
| Intent Gateway | Layer 5 | 将用户输入转换为建议性 Intent Classification Result，并通过仓库权威的全局 Codex Skill 提供新对话入口、显式退出和渐进上下文路由 | Completed（Global Skill 已安装，待新对话验证） | [Gateway](../intent/INTENT_GATEWAY_STANDARD.md)、[Classification](../intent/INTENT_CLASSIFICATION_STANDARD.md)、[Evidence](../intent/INTENT_EVIDENCE_STANDARD.md)、[Global Skill Design](../superpowers/specs/2026-08-06-global-ai-cto-skill-gateway-design.md)、[Global Skill Plan](../superpowers/plans/2026-08-06-global-ai-cto-skill-gateway-implementation.md)、[Global Skill Source](../../skills/ai-cto-system/SKILL.md)、[ADR-0015](../adr/ADR-0015-INTENT-GATEWAY-GOVERNANCE.md) |
